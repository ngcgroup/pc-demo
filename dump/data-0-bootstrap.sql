...
CREATE TABLE `bundle_outputdataconfigtoolkit_outputdefinition` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Unique` ( `id`, `classId`,`channel`)
...
CREATE TABLE `object_brick_query_Bodywork_CAR` (
  ...
  CONSTRAINT `fk_object_brick_query_Bodywork_CAR__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
...
CREATE TABLE `object_brick_query_Dimensions_CAR` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_query_Dimensions_CAR__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_query_Engine_CAR` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_query_Engine_CAR__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_query_OAuth1Token_3` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_query_OAuth1Token_3__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_query_OAuth2Token_3` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_query_OAuth2Token_3__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_query_SaleInformation_AP` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_query_SaleInformation_AP__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_query_SaleInformation_CAR` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_query_SaleInformation_CAR__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_query_Transmission_CAR` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_query_Transmission_CAR__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_store_Bodywork_CAR` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_store_Bodywork_CAR__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_store_Dimensions_CAR` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_store_Dimensions_CAR__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_store_Engine_CAR` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_store_Engine_CAR__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_store_OAuth1Token_3` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_store_OAuth1Token_3__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_store_OAuth2Token_3` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_store_OAuth2Token_3__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_store_SaleInformation_AP` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_store_SaleInformation_AP__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_store_SaleInformation_CAR` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_store_SaleInformation_CAR__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_brick_store_Transmission_CAR` (
  ...
  KEY  `id` ( `id`),
  KEY `fieldname` (`fieldname`),
  CONSTRAINT `fk_object_brick_store_Transmission_CAR__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_classificationstore_data_AP` (
  ...
  CONSTRAINT `fk_object_classificationstore_data_AP__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_classificationstore_groups_AP` (
  ...
  CONSTRAINT `fk_object_classificationstore_groups_AP__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_FilterCategoryMultiselect_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_FilterCategoryMultiselect_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_FilterCategory_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_FilterCategory_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_FilterInputfield_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_FilterInputfield_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_FilterMultiRelation_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_FilterMultiRelation_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_FilterMultiSelect_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_FilterMultiSelect_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_FilterNumberRangeSelection_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_FilterNumberRangeSelection_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_FilterNumberRange_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_FilterNumberRange_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_FilterRelation_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_FilterRelation_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_FilterSelectFromMultiSelect_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_FilterSelectFromMultiSelect_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_FilterSelect_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_FilterSelect_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_NewsCars_NE` (
  ...
  CONSTRAINT `fk_object_collection_NewsCars_NE__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_NewsLinks_NE` (
  ...
  CONSTRAINT `fk_object_collection_NewsLinks_NE__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_NewsText_NE` (
  ...
  CONSTRAINT `fk_object_collection_NewsText_NE__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_OrderByFields_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_OrderByFields_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_OrderPriceModifications_EF_OSO` (
  ...
  CONSTRAINT `fk_object_collection_OrderPriceModifications_EF_OSO__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_PaymentInfo_EF_OSO` (
  ...
  CONSTRAINT `fk_object_collection_PaymentInfo_EF_OSO__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_PricingRule_EF_OSOI` (
  ...
  CONSTRAINT `fk_object_collection_PricingRule_EF_OSOI__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_SimilarityField_EF_FD` (
  ...
  CONSTRAINT `fk_object_collection_SimilarityField_EF_FD__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_TaxEntry_EF_OSTC` (
  ...
  CONSTRAINT `fk_object_collection_TaxEntry_EF_OSTC__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_VoucherTokenTypePattern_EF_OSVS` (
  ...
  CONSTRAINT `fk_object_collection_VoucherTokenTypePattern_EF_OSVS__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_collection_VoucherTokenTypeSingle_EF_OSVS` (
  ...
  CONSTRAINT `fk_object_collection_VoucherTokenTypeSingle_EF_OSVS__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `object_metadata_CU` (
  ...
  CONSTRAINT `fk_object_metadata_CU__o_id` FOREIGN KEY ( `id`) REFERENCES `objects` ( `id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
